...
2. Review [`hallucination-taxonomy.md`](https://github.com/isaacochekwu/Medical-AI-Evaluation-Guidelines/blob/main/Hallucination%20taxonomy.md) to learn how I categorize errors
3. See the [`examples`](https://github.com/isaacochekwu/Medical-AI-Evaluation-Guidelines/blob/main/Good%20output%20example.md) folder for real annotated cases
4. Refer to [`annotation-best-practices.md`](https://github.com/isaacochekwu/Medical-AI-Evaluation-Guidelines/blob/main/Annotation%20best%20practices.md)for workflow tips
